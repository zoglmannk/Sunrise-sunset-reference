...
public class Calculator {
	 ...
	 */
	private static final double CIVIL_TWILIGHT_OFFSET = -5.8; // degrees above or below horizon
	...
	private static final double DEGREE_OFFSET = 0;
	private TestResult testHourForEvent(
		...
		double Z = Math.cos(zenithDistance) + DEGREE_OFFSET*DR;
